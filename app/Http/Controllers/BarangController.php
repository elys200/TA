    ...
    public function generateKode($barang_id, $tanggal)
{
    ...
    $count = PeminjamanBarang::where('barang_id', $barang_id)
        ->whereDate('tanggal_mulai_peminjaman', $tanggal)
        ->count();
    ...
    public function store(Request $request, $id)
{
    ...
    return back()->withErrors([
        'jumlah_barang' => 'Stok tidak mencukupi'
    ])->withInput();
    }
    ...
    DB::transaction(function () use ($validateData, $barang) {
        ...
        PeminjamanBarang::create([
            'nama_penanggung_jawab' => $validateData['nama_penanggung_jawab'],
    ...
    return redirect()->route('statuspeminjamanbarang')
        ->with('success', 'Peminjaman Barang berhasil dilakukan');
}
