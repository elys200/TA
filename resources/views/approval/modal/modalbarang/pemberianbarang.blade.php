<div class="modal fade" id="modalPemberianBarang" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('approvalbarang.given', $peminjaman->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <label for="formFile" class="form-label fw-bold">Foto Pemeberian</label>
