        ...
        <div class="card-body">
            ...
            <div class="row text-center justify-content-center mt-2 mb-4">
                ...
                <div class="col-12 col-md-4 mb-4 mt-3">
                    ...
                    Carbon::parse($peminjaman->tanggal_mulai_peminjaman)->isToday())
                    <div class="d-flex justify-content-center gap-2 mb-4">
                        <button type="button" class="btn btn-success btn-lg" data-bs-toggle="modal"
                ...
                <div class="col-12 col-md-4 mb-4 mt-3">
                    ...
                    <p class="text-center text-muted">
                        Menunggu pemberian barang terlebih dahulu
                    </p>

                    @elseif(!is_null($peminjaman->given_by) && is_null($peminjaman->returned_by))
                    <div class="d-flex justify-content-center gap-2 mb-4">
                        <button type="button" class="btn btn-success btn-lg" data-bs-toggle="modal"
