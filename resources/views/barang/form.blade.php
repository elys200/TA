        ...
        <form action="{{ route('barang.borang', $barang->id) }}" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="ormawa_id" required>
                    ...
                    <option value="{{ $ormawas->id }}" {{ old('ormawa_id') == $ormawas->id ? 'selected' : '' }}>
                        {{ $ormawas->nama_ormawa }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="" name="tanggal_mulai_peminjaman"
                    value="{{ old('tanggal_mulai_peminjaman') }}" min="{{ now()->addDays(2)->toDateString() }}"
                    required>
            </div>
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="" name="tanggal_selesai_peminjaman"
                    value="{{ old('tanggal_selesai_peminjaman') }}" min="{{ now()->addDays(2)->toDateString() }}"
                    required>
            </div>
            <div class="col-md-6">
