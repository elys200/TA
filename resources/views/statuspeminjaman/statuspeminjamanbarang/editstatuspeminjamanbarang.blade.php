        ...
        <div id="main">
            ...
            <div class="container-fluid">
                ...
                <div class="bg-white p-4 rounded-3 shadow-sm">
                    ...
                    <form action="{{ route('statuspeminjaman.updatepeminjamanbarang' , $peminjaman->id) }}" method="POST" class="row g-3">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama_penanggung_jawab"
                                name="nama_penanggung_jawab" value="{{ old('nama_penanggung_jawab' , $peminjaman->nama_penanggung_jawab) }}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="" name="tanggal_mulai_peminjaman"
                                value="{{ old('tanggal_mulai_peminjaman', $peminjaman->tanggal_mulai_peminjaman) }}" min="{{ now()->addDays(2)->toDateString() }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="" name="tanggal_selesai_peminjaman"
                                value="{{ old('tanggal_selesai_peminjaman', $peminjaman->tanggal_selesai_peminjaman) }}" min="{{ now()->addDays(2)->toDateString() }}" required>
                        </div>
                        <div class="col-md-6">
