                        ...
                        <div class="hello">
                            <div class="row text-center align-items-center">
                                <div class="col-8 text-start">
                                    <p style="margin: 0; font-weight: bold; font-size: 25px; color: #fff;">
                                        Hallo, Elys!
                                    </p>
                                    <p style="margin: 2px 0 0 0; font-size: 15px; color: #fff;">
                                        Nice To Meet You Again
                                    </p>
                                </div>
                                <div class="col-4 d-flex justify-content-end">
                                    <img src="{{ asset('images/gambar.png') }}" alt="gambar" class="hello-img"
                                        style="height: 80px">
                                </div>
                            </div>
                        </div>
